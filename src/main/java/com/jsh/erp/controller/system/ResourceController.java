package com.jsh.erp.controller.system;

import com.alibaba.fastjson.JSONObject;
import com.jsh.erp.constants.BusinessConstants;
import com.jsh.erp.service.common.CommonQueryManager;
...
public class ResourceController {
    ...
    public String getList(@PathVariable("apiName") String apiName,
        ...
        if (list != null) {
            ...
            String res = returnJson(objectMap, ErpInfo.OK.name, ErpInfo.OK.code);
            return res;
        } else {
